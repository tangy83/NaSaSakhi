// NextAuth configuration object — extracted here so it can be imported by
// both the route handler (app/api/auth/[...nextauth]/route.ts) and server
// utilities (lib/auth.ts) without violating Next.js route export rules.
