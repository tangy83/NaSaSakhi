...
--
-- Table structure for table `new_service_resource`
--

DROP TABLE IF EXISTS `new_service_resource`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `new_service_resource` (
  `CategoryID` text,
  `ResourceID` text,
  `Service_Group` text,
  `LanguageID` text,
...
-- Dump completed on 2026-01-03 18:44:56
